...
import VolunteerApplication from 'app/pages/dashboard/view-volunteer-application';
...
ReactDOM.render(
    <Router history={ hashHistory }>
        ...
        <Route path='/voluntapp' component={ LayoutBlank }>
            <IndexRoute component={ VolunteerApplication }/>
        </Route>
        </Router>,
    app
);
