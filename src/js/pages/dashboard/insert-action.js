...
export default class InsertAction extends AuthorizedComponent {
    ...
    render () {
        return (
            <div>
                <h1 className='col-sm-offset-5'>Insert Action</h1>
                <form className='form-horizontal' onSubmit={ this.handleSubmit }>
                    <div className='form-group'>
                        <LabelForm htmlFor='formType' title='Type' className='control-label col-sm-2 col-sm-offset-1'/>
                    ...
                    <div className='form-group'>
                        ...
                        <div className='col-sm-6'>
                            <input id='formDescription' className='form-control' name='description' type='text'
                                   required onChange={ this.handleChange } value={ this.state.action.description }
                    ...
                    <div className='form-group'>
                        <LabelForm htmlFor='availablePosition' title='Available Positions'
                                   className='control-label col-sm-2 col-sm-offset-1'/>
                        <div className='col-sm-6'>
                            <input id='availablePosition' className='form-control' name='availablePosition' type='number'
                                   required onChange={ this.handleChange } value={ this.state.action.availablePosition }
