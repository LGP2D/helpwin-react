...
class VolunteerApplicationStore extends EventEmitter {
    constructor (){
        super();
...
const volunteerApplicationStore = new VolunteerApplicationStore();
dispatcher.register(volunteerApplicationStore.handleActions.bind(volunteerApplicationStore));

export default volunteerApplicationStore;
